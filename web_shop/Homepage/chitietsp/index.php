            ...
            <div class="container-fluid">
                <div>
                    ...
                    <tr>
                        ...
                        <td >
                        <p class="mota"><b>Kích thước:</b>' . $item['kichthuoc'] . '<br><br><b>Tính năng màn hình:</b>' . $item['tinhnangmh'] . '
                        <br><br><b>Camera sau:</b>' . $item['camsau'] . '<br><span id="quay"><br><b>Khả năng quay:</b>' . $item['quay'] . '</span></p>
                        <br><p class="gia"><b><i>Giá: ' . number_format($product['price']) . '&ensp;VNG</i></b></p>
                        </td>
                    </tr>
                    <tr>
                    </tr>
